...
# Allow experiments that keep SN voxels in the control masks by setting
# BLACKANT_SUBTRACT_SN=0. The default (1) preserves the historical behavior of
# removing overlap so the control backgrounds stay free of SN signal.
